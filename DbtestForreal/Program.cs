       ...
       public static void Main(string[] args)
        {
            ...
            using (var dbContext = new PlantDbContext(options))
            {
                ...
                {
                    Console.WriteLine($"Retrieved Plant Data: Id={retrievedPlantData.Id}, Name={retrievedPlantData.PlantName}, Water Temperature={retrievedPlantData.WaterTemperature}, pH Level={retrievedPlantData.WaterPhLevel}, Water Flow={retrievedPlantData.WaterFlow}");
                }
                else
                {
